...
if(checkFile){
  ...
  var dummy = moment().add(2, 'days').format('MM-DD-YY HH:mm:ss')
  storageData = [
                    {runTime: dummy,cmd:"pwd",nextRun:{days:1,mins:'r',sec:'r'}}, // next run will be in 1 day (randomize seconds and minutes)
