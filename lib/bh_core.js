...
var control = require('./bh_control.js');
...
const tools = {
		...
		tt:control.time,
		min:control.addMinutes,
		day:control.addDays,
		rm:control.setRandomMinutes,
		rs:control.setRandomSeconds,
		run:cmd.run,
		processNextRun:control.nextRun,
...
async function sysStartUp(){
  return new Promise(async function(resolve,reject){
    ...
    if(checkFile){
      ...
      await control.setStorageData(await createDummyData());
    }
  });
}
//
