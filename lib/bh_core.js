...
return new Promise(async function(resolve,reject){
  ...
  let dummyData = [
                    ...
                    {runTime: "'"+moment().add(8, 'minutes').format('MM-DD-YY HH:mm:ss')+"'",cmd:"ls",nextRun:{mins:3}}, // next run will be in 3 minutes. (randomize seconds) 
                    {runTime: "'"+moment().add(8, 'minutes').format('MM-DD-YY HH:mm:ss')+"'",cmd:"echo 'happy new year world!!!'"}, 
